  ...
  return (
    <li>
      <NavLink
        ...
        className={({ isActive }) =>
          twMerge(
            'relative dark:text-neutral-300 dark:hover:text-neutral-100 text-neutral-600 hover:text-neutral-950 transition-colors outline-none focus-visible:text-neutral-950',
            isActive &&
